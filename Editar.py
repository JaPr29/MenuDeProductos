...
def Editar(información):
    try:
        ...
        while True: # Empieza el menú.
            try:
                print(f"Hola {información[1]}, este es el menú para editar los Productos, dime ¿Qué quieres hacer? \n1. Editar un Producto \n2. Volver al menú principal")
            ...
            if Buscar == producto.nombre:
                ...
                while True:
                    ...
                    if OpciónElegida == 1:
                        ...
                        while not NuevoPrecio.isnumeric():
                        ...
                        while not NuevoStock.isnumeric():
                        ...
                        while not NuevaSección.isalpha():
